...
const EditBookPage = ({ updateBookSubmit }) => {
  ...
  const [sellerName, setSellerName] = useState(book.seller.name);
  const [sellerDescription, setSellerDescription] = useState(
    book.seller.description
  );
  const [contactEmail, setContactEmail] = useState(book.seller.contactEmail);
  const [contactPhone, setContactPhone] = useState(book.seller.contactPhone);
